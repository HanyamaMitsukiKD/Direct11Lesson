...
bool KdMeshIntersect(const KdMesh& mesh, const DirectX::XMVECTOR& rayPos, const DirectX::XMVECTOR& rayDir,
...
bool KdMeshIntersect(const KdMesh& mesh, const DirectX::BoundingSphere& sphere,
	const DirectX::XMMATRIX& matrix, CollisionMeshResult* pResult)
{
	...
	for (UINT fi = 0; fi < faceNum; fi++)
	{
		...
		// 点 と 三角形 の最近接点を求める
		KdCalcNearestPointToPolygon(finalPos,
...
// 点 vs 三角形との最近接点を求める
void KdCalcNearestPointToPolygon(const XMVECTOR& p, const XMVECTOR& a, const XMVECTOR& b, const XMVECTOR& c, DirectX::XMVECTOR& outPt)
{
