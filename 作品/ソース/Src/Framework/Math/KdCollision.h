...
bool KdMeshIntersect(const KdMesh& mesh, const DirectX::XMVECTOR& rayPos, const DirectX::XMVECTOR& rayDir, float rayRange,
...
void KdCalcNearestPointToPolygon(const DirectX::XMVECTOR& point, const DirectX::XMVECTOR& v1,
